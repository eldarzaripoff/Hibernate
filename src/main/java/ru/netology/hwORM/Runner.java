...
public class Runner implements CommandLineRunner {
    ...
    @Bean
    CommandLineRunner initDatabase(DBRepository DBRepository) {
        ...
        Persons rustem = Persons.builder()
                ...
                .build();
        return args -> {
            DBRepository.save(michael);
            DBRepository.save(yunus);
            DBRepository.save(eldar);
            DBRepository.save(rustem);
        };
